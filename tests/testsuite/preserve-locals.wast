...
;; issue #3 exact example
(module
  (func (export "issue3.run") (param $cond i32) (param $x i32) (result i32)
    (drop (i32.add (local.get $x) (i32.const 10)))
    (local.get $x)
    (block
      (local.get $cond)
      (br_if 0)
      (local.set $x (i32.const 1)))))
(assert_return (invoke "issue3.run" (i32.const 1) (i32.const 42)) (i32.const 42))
(assert_return (invoke "issue3.run" (i32.const 0) (i32.const 42)) (i32.const 42))
